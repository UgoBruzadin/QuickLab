...
%        % Check  consistency of freqs
  ...
  % Main view area — axes go directly in mainPanel (no tabs for now)
  % Tabs for Components/Spectra/ERPs will be added in a future version
  % using separate figures or a properly isolated axes architecture.
  viewTabs = [];
  dataTab = mainPanel;  % axes parent is the main panel itself
  ...
  %% %%%%%%%%%%%%%%%%%%%%%%%%
  %  Create axes in main panel
  %  %%%%%%%%%%%%%%%%%%%%%%%%

  % Axes position within mainPanel (above the nav bar)
  MAIN_AXES_POS = [DEFAULT_AXES_POSITION(1), 0.07 + DEFAULT_AXES_POSITION(2), ...
                   DEFAULT_AXES_POSITION(3), DEFAULT_AXES_POSITION(4) * 0.90];

  % Background axis
  ax0 = axes('tag','backeeg','parent', figh,...
      'Position', MAIN_AXES_POS,...
  ...
  ax1 = axes('Position', MAIN_AXES_POS,...
      'userdata', data, ...
