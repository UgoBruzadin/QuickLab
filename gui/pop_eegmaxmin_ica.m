...
function [EEG, com] = pop_eegmaxmin_ica(EEG,chanRange,timeRange,minmaxThresh,winSize,stepSize,maW)
...
elseif nargin < 6
    [~, ~, ~, res] = inputgui(...
        ...
        {'Style', 'edit', 'string', ['1:' num2str(size(EEG.icawinv, 2))] 'tag' 'chans' } ...
    ...
    EEG = eegmaxmin_ica(EEG,chanRange,timeRange,minmaxThresh,winSize,stepSize,maW);
end
